...
RETURNS TABLE (
  ...
  display_name TEXT,
  description TEXT,
  group_type TEXT, -- ADDED: This defines which tab the service belongs to
...
BEGIN
    ...
    SELECT 
      ...
      st.description, 
      -- Logic to separate into Rides vs Delivery
      CASE 
        WHEN st.name IN ('bike', 'shuttle', 'van_truck') THEN 'delivery'
        ELSE 'rides'
      END as group_type,
